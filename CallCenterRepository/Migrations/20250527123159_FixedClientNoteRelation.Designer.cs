...
namespace CallCenterRepository.Migrations
{
    ...
    [Migration("20250527123159_FixedClientNoteRelation")]
    partial class FixedClientNoteRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CallCenterRepository.Models.Client", b =>
                {
                    ...
                    b.Property<int?>("ProjectPkProject")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CallCenterRepository.Models.ClientNote", b =>
                {
                    ...
                    b.Property<int?>("ConversationPkTalk")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CallCenterRepository.Models.Client", b =>
                {
                    b.HasOne("CallCenterRepository.Models.Project", null)
                        .WithMany("Clients")
                        .HasForeignKey("ProjectPkProject");
                });

            modelBuilder.Entity("CallCenterRepository.Models.ClientNote", b =>
                {
                    b.HasOne("CallCenterRepository.Models.Conversation", null)
                        .WithMany("Notes")
                        .HasForeignKey("ConversationPkTalk");
